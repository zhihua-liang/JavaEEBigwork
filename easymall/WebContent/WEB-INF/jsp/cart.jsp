...
<body>
	...
	<div id="wrap">
		...
		<c:forEach items="${carts}" var="cart">
			<ul class="prods">
				<li><input type="checkbox" class="prodC" id="${cart.cartID}" /></li>
				<li class="li_prod"><img
					src="${pageContext.request.contextPath}${cart.imgurl}"
					width="90" height="90" class="prodimg" /> <span class="prodname">${cart.name}</span>
				</li>
				<li class="li_price">${cart.price}</li>
				<li><a href="javascript:void(0)" class="delNum">-</a> <input
					class="buyNumInp" id="${cart.cartID}" type="text" 
					 readonly="readonly" value="${cart.num}" />
					<a href="javascript:void(0)" class="addNum">+</a></li>
		...
		<div id="total">
			<div id="total_1">
				<input type="checkbox" class="allC" name="allC" /> <span>全选</span> <a
					id="del_a" class="del_all" href="javascript:void(0)">删除选中的商品</a>
				<div id="div_sum">
					<span id="span_1">总价：</span> <span>￥</span> <span id="span_2"
						class="total_sum_price">${sum}</span>&nbsp;&nbsp;&nbsp;
				</div>
			</div>
			<div id="total_2">
